package com.infinitylearn.swipebutton.View;

import static com.infinitylearn.swipebutton.Util.Dimension_Util.spToPx;
import static com.infinitylearn.swipebutton.Util.Drawable_Color_Util.setDrawableColor;
import static com.infinitylearn.swipebutton.Util.Drawable_Color_Util.setDrawableStroke;
...
import com.infinitylearn.swipebutton.Controller.OnSwipeCompleteListener;
import com.infinitylearn.swipebutton.Controller.Swipe_Button_Controller;
import com.infinitylearn.swipebutton.R;
...
public class Swipe_Button_View extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    protected float swipeTextSize = spToPx(12, getContext());
    ...
    private void getAttributes(TypedArray attributes) {
        ...
        ThumbImageId = attributes.getResourceId(R.styleable.SwipeButtonView_sb_thumb_image, R.drawable.group);
